...
from bedrock_a_party.classes.party import CannotPartyAloneError, Party, NotInvitedGuestError, ItemAlreadyInsertedByUser, \
...
def get_single_party(_id):
    global _LOADED_PARTIES

    party = _LOADED_PARTIES[str(_id)]
...
def get_party_foodlist(_id):
    global _LOADED_PARTIES

    party = _LOADED_PARTIES[str(_id)]
    return jsonify(foodlist=party.get_food_list().serialize())
